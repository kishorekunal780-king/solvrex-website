export const TRUST = [
  {
    ...
    body: "Every profile receives real human review and feedback.",
  },
  {
    title: "Personalized Guidance",
    body: "Recommendations tailored to your goals and experience.",
  },
  {
    title: "Independent Advice",
    body: "No recruitment commissions or hidden incentives.",
  },
  {
    title: "Practical Support",
    body: "Focused on actions that improve outcomes.",
  },
];
